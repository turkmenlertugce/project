...
const AccountActivation = () => {
    ...
    const activate = () => {
        axios.post(`hhttps://faxriboot-env.eba-dincnkef.us-east-1.elasticbeanstalk.com/api/activate_account/confirm?token=${location.pathname.substring(19)}`, {password:password,passwordAgain:passwordAgain}).

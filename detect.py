...
def run(
    weights=ROOT / "weights/light_best-fp16.tflite",  # model path or triton URL
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for c in det[:, 5].unique():
                    ...
                    s += f"{n} {names[int(c)]}{' *D* ' * (n > 0)}, "  # add to string
...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "weights/light_best-fp16.tflite", help="model path or triton URL")
